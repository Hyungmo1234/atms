...
<body>
   ...
   <div id="join">
      <div
         ...
         <h1>社員登録画面</h1>
         <form action="/JoinPOST" id="JoinPOST" name="JoinPOST" method="post" style="margin-left: 40%;">
            <table id="tab1">
               <tr>
            ...
            <table id="tab3">
               <tr id="p1">
                  ...
                  <td id="password1" style="width : 158px;">: <input type="password" id="password" name="password"></td>
               </tr>
               <tr id="p2">
            ...
            <table>
               ...
               <tr>
                  <td rowspan="2">
                     ...
                     <button type="submit" id="join" name="join" onclick="return finish()">登録完了</button>
                  </td>
               </tr>
            </table>
            </td>
...
<script type="text/javascript">
   ...
   function finish() {
       var email = document.JoinPOST.mail.value;
