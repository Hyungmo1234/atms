...
public class AjaxController {
  ...
  public String JoinPOST2(@RequestParam("com_code1") String com_code, Model model)
      throws Exception {
  ...
  public String JoinPOST3(@RequestParam("com_code1") String com_code, Model model)
      throws Exception {
  ...
  public String IdPOST(@RequestParam("id") String id, Model model, HttpServletResponse response)
      throws Exception {
    /*
   ...
   * JoinGET(@RequestParam("com_name") String com_name,Model model) throws Exception {
   * 
